...
import ProductPage from "./CeilingFanProductPage.jsx";
import { productsData } from "./CeilingFanData.js";
import AboutHeroSection from "../../../components/AboutHeroSection/AboutHeroSection.jsx";

const CeilingFanProductList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <AboutHeroSection title={"Ceiling Fan"} />
...
export default CeilingFanProductList;
