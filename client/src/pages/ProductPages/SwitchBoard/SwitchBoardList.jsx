...
import ProductPage from "./SwitchBoardProductPage.jsx";
import { productsData } from "./SwitchBoardData.js";
import AboutHeroSection from "../../../components/AboutHeroSection/AboutHeroSection.jsx";

const SwitchBoardProductList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <AboutHeroSection title={"Switch Board"} />
...
export default SwitchBoardProductList;
