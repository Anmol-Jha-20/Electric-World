...
import ProductPage from "./COBLightProductPage.jsx";
import { productsData } from "./COBLightData.js";
import AboutHeroSection from "../../../components/AboutHeroSection/AboutHeroSection.jsx";

const COBLightProductList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <AboutHeroSection title={"COB Light"} />
...
export default COBLightProductList;
