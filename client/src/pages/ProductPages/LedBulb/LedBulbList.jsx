...
import ProductPage from "./LedBulbProductPage.jsx";
import { productsData } from "./LedBulbData.js";
import AboutHeroSection from "../../../components/AboutHeroSection/AboutHeroSection.jsx";

const LedBulbProductList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <AboutHeroSection title={"LED Bulb"} />
...
export default LedBulbProductList;
